...
public class HuntTheWumpus extends JFrame {
    ...
    public HuntTheWumpus() {
        setTitle("Hunt the Wumpus - 2D Engine Demo");
        setSize(800, 600); 
        setDefaultCloseOperation(EXIT_ON_CLOSE);
        setLayout(new BorderLayout());

        // 1. Create your new engine
        ControlEngine engine = new ControlEngine();
        
        // 2. Add it to the window (Replacing the old JTextArea for now)
    ...
    void endGame() {
        ...
        // Removed button disabling logic since buttons are gone
    }
